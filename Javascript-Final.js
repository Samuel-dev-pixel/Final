...
function comprobar() {
    ...
    if (a.value==1&&n__pregunta==8) { if (h.value=0) {
    	if (g.value==1) {
                  if (f.value==1){
                     ...
                     if (d.value==1) {
                  	...
                  	if (e.value==1) {
                  		...
                  		} {n__pregunta=6} {n__pregunta=Math.round(Math.random()*(4-2)+parseInt(2));}
                  	} {n__pregunta=Math.round(Math.random()*(6-5)+parseInt(5));} {n__pregunta=6;}
                  		if (d.value==1) {
                  			if (c.value==1) {
                  				if (b.value==1) {
                  ...
                  }  {n__pregunta=Math.round(Math.random()*(6-2)+parseInt(2));} 
    	} else {
    		if (f.value==1) {
                     if (e.value==1) {
                     	...
                     	if (c.value==1) {
                   		...
                   		if (d.value==1) {
                   			...
                   			if (c.value==1) {
                   				...
                   				if (b.value==1) {
                                    {n__pregunta=Math.round(Math.random()*(5-3)+parseInt(3));}
                                     {n__pregunta=Math.round(Math.random()*(5-2)+parseInt(2));}
                             }     
                         }
                   	}
                   } {
    ...
    } {n__pregunta=Math.round(Math.random()*(7-2)+parseInt(2));}} } {
